...
@section('content')
    ...
    if ($type === 'insert') {
        ...
        $Duration = !empty($taskData) ? $taskData['Duration'] ?? '' : '';
        $UserId = !empty($taskData) ? $taskData['UserId'] ?? '' : '';
        $status = !empty($taskData) ? $taskData['Status'] ?? '' : '';
    } else {
                ...
                <div class="row g-3 align-items-center">
                    <div class="col">
                        ...
                        <ol class="breadcrumb bg-transparent mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('projects.userStoryDetails', ['Id' => $UserStoryId]) }}">User Story Details</a>
                        ...
                        <form validated="false" id="formTask" todo="{{ $todo }}" method="POST"
                            ...
                            <div class="profile-overview">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ old('TaskName') ?? $Title }}" required id="TaskName" name="TaskName"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea value="" required id="TaskDescription" name="TaskDescription" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ old('TaskStartDate') ?? $StartDate }}" required name="TaskStartDate"
                                            id="TaskStartDate" type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 label">End Date<code>*</code></label>
                                    <div class="col-sm-10">
                                        <input value="{{ old('TaskEndDate') ?? $EndDate }}" required name="TaskEndDate"
                                            id="TaskEndDate" type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 label">Actual Start Date</label>
                                    <div class="col-sm-10">
                                        <input value="{{ old('ActualTaskStartDate') ?? $ActualStartDate }}"
                                            name="ActualTaskStartDate" id="ActualTaskStartDate" type="datetime-local"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ old('ActualTaskEndDate') ?? $ActualEndDate }}"
                                            name="ActualTaskEndDate" id="ActualTaskEndDate" type="datetime-local"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputTime" class="col-sm-2 label">Duration(in hrs.)</label>
                                    <div class="col-sm-10">
                                        <input value="{{ old('TaskDuration') ?? $Duration }}" name="TaskDuration"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" name="TaskUserAssigned" id="TaskUserAssigned"
                                            aria-label="State">
                                            <option value="" selected disabled>Select User</option>
                                            @foreach ($userList as $users)
                                                <option {{ $UserId == $users->Id ? 'selected' : '' }}
                                                    value="{{ $users->Id }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select required class="form-select" name="TaskStatus" id="TaskStatus"
                                            aria-label="status">
