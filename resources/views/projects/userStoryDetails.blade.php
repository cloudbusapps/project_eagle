                ...
                <div class="row g-3 align-items-center">
                    <div class="col">
                        ...
                        <ol class="breadcrumb bg-transparent mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('projects.projectDetails', ['Id' => $userStoryData->ProjectId]) }}">Project Details</a></li>
                            ...
                            <tbody>
                                @foreach ($taskData as $index => $tasks)
                                    ...
                                    if(!empty($tasks->TimeCompleted)){
                                        $seconds = $tasks->TimeCompleted;
                                    $dtF = new DateTime('@0');
                                    $dtT = new DateTime("@$seconds");
                                    $timeCompleted = $dtF->diff($dtT)->format('%a days, %h hours, %i minutes');
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $tasks->UserId ? $fullname : 'None' }}</td>
                                        <td><?= $statusDisplay ?></td>
                                        <td><?= $timeCompleted ?></td>
                                    </tr>
                                @endforeach
