...
<main id="main" class="main" employees="{{ $employees }}">
            ...
            <div class="row g-3 align-items-center">
                <div class="col">
                    ...
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('moduleApproval') }}">Module Approval</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $title }}</li>
                    </ol>
                </div>
                <div class="col text-end">
                    <a href="{{ route('moduleApproval') }}" class="btn btn-secondary">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            <div class="row my-3">
                                <label for="Module" class="col-sm-2">Module Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="Module" name="Module" placeholder="Module"
                                        value="{{ $data->Title }}" disabled readonly>
                                </div>
                            </div>
                            <div class="row my-3 pt-3">
                                <div class="col-md-3 col-sm-12">
                                    <div class="list-group">
                                        ...
                                        @forelse ($designations as $index => $dt)
                                        <a href="#" class="list-group-item btnDesignation" moduleId="{{ $data->id }}" designationId="{{ $dt['Id'] }}">{{ $dt['Name'] }}</a>
                                        @empty
                                        <a href="#" class="list-group-item disabled">No data found</a>
                                        @endforelse
                                ...
                                <div class="col-md-9 col-sm-12" id="displayApprover">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/img/modal/select.svg') }}" alt="Select Designation" width="200" height="200">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // ----- SUBMIT FORM -----
        $(document).on('submit', '#formModuleApproval', function(e) {
