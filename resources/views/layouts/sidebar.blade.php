...
<div class="sidebar p-2 py-md-3 @@cardClass version-2">
    <div class="container-fluid">
        <div class="title-text d-flex align-items-center mb-4 mt-1">
            <img class="sidebar-img img-thumbnail shadow" src="{{ asset('assets/img/epldt-suite-logo.png') }}"
                height="50" width="50" alt="ePLDT">
            <h4 class="sidebar-title mb-0 flex-grow-1 px-2 d-none d-xl-block"><span class="sm-txt fw-bold"
                    style="color: #d0021b;">ePLDT</h4>
        </div>
        ...
        <div class="main-menu flex-grow-1 pb-3">
                        ...
                        <li class="{{ in_array($module['Prefix'], $prefixArray) ? 'collapsed' : '' }}">
                            @if (count($module['items']))
                                <a class="m-link" data-bs-toggle="collapse"
                                    data-bs-target="#menu-{{ $module['Prefix'] }}" href="#"
                                    aria-expanded="{{ in_array($module['Prefix'], $prefixArray) ? 'true' : 'false' }}">
                                    <img src="{{ asset('uploads/icons/' . $module['Icon']) }}"
                                        alt="{{ $module['Title'] }}" width="20" height="20">
                                    <span class="ms-2">{{ $module['Title'] }}</span>
                                    <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                                </a>
                                <ul class="sub-menu collapse {{ in_array($module['Prefix'], $prefixArray) ? 'collapsed show' : '' }}"
                                    id="menu-{{ $module['Prefix'] }}">
            ...
            <ul class="menu-list">
                @if (Auth::user()->IsAdmin)
                    ...
                    <li>
                        <a class="m-link {{ $subModule == 'integration' ? 'active' : '' }}"
                            href="{{ '#' }}">
                            <img src="{{ asset('uploads/icons/integration.png') }}" alt="Integration" width="20"
                                height="20">
                            <span class="ms-2">Integration</span>
                        </a>
                    </li>
                    <li class="{{ in_array('setup', $prefixArray) ? 'collapsed' : '' }}">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-setup" href="#"
                            aria-expanded="{{ in_array('setup', $prefixArray) ? 'true' : 'false' }}">
                            <img src="{{ asset('uploads/icons/setup.png') }}" alt="Setup" width="20"
                                height="20">
                            <span class="ms-2">Setup</span>
                            <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                        </a>
                        <ul class="sub-menu collapse {{ in_array('setup', $prefixArray) ? 'collapsed show' : '' }}"
                            id="menu-setup">
                            <li>
                        ...
                        <div class="dropdown morphing scale-left notifications">
                            <a class="nav-link dropdown-toggle after-none" href="#" role="button"
                                ...
                                @if (count($notifications) > 0)
                                    <span class='badge badge-warning text-danger'>{{ count($notifications) }}</span>
                                @endif
                        ...
                        <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                            <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#"
                                ...
                                <img class="avatar img-thumbnail rounded-circle shadow"
                                    src="{{ asset('uploads/profile/' . Auth::user()->Profile ?? 'default.png') }}"
                                    alt="">
                            </a>
                                ...
                                <div class="card border-0 w240">
                                    <div class="card-body border-bottom d-flex">
                                        ...
                                        <div class="flex-fill ms-3">
                                            ...
                                            <small
                                                class="text-muted">{{ Designation::find(Auth::user()->DesignationId)->Name ?? '-' }}</small>
                                        </div>
                                    </div>
                                    <div class="list-group m-2 mb-3">
                                        <a class="list-group-item list-group-item-action border-0"
                                            href="{{ route('user.viewProfile') }}"><i class="w30 fa fa-user"></i>My
                                            Profile</a>
                                    </div>
