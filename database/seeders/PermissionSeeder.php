...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('permissions')->insert([
            // MODULE TWO OPPORTUNITY PERMISSION
            [
                'Id'            => Str::uuid(),
            ...
            // MODULE TWO DASHBOARD PERMISSION
            [
                'Id'            => Str::uuid(),
                'DesignationId' => $GMDesignationId,
                'ModuleId'      => $module2DashboardId, 
                'Read'          => 1,
                'Create'        => 1,
                'Edit'          => 1,
                'Delete'        => 1,
            ...
            // MODULE TWO TIMEKEEPING PERMISSION
            [
                'Id'            => Str::uuid(),
                'DesignationId' => $GMDesignationId,
                'ModuleId'      => $module2TimekeepingId, 
                'Read'          => 1,
                'Create'        => 1,
                'Edit'          => 1,
                'Delete'        => 1,
